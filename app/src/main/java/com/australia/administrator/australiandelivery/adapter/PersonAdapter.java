...
public class PersonAdapter extends RecyclerView.Adapter<PersonAdapter.ViewHolder> {
    ...
    public List<ShopDetailsBean.MsgBean.ShopmessageBean.GoodsBean> selectGoods = new ArrayList<>();
    private ViewHolder viewHolder;

    public PersonAdapter(Context context, List<ShopDetailsBean.MsgBean.ShopmessageBean.GoodsBean> items
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        //设置说明
        holder.tvGoodsDescription.setText(dataList.get(position).getGoodscontent());
        //设置价格
...
//        Glide.with(mContext).load(dataList.get(position).getGoodsphoto()).centerCrop()
...
//                .into(holder.ivGoodsImage);
        ...
        holder.ivGoodsImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(mContext, DishDetailActivity.class);
                i.putExtra("dishpic",dataList.get(position).getGoodsphoto());
                i.putExtra("dishname",dataList.get(position).getGoodsname());
                i.putExtra("dishprice",dataList.get(position).getGoodsprice());
                i.putExtra("dishcontent",dataList.get(position).getGoodscontent());
    ...
    private void jia(int position ,ViewHolder holder,String type){
            ...
            for (int i = 0; i < selectGoods.size(); i++) {
                if (type.equals("1")){
                    ...
                    if (selectGoods.get(i).getGoodsid().equals(dataList.get(position).getGoodsid())) {
                        ...
                        if (!selectGoods.contains(dataList.get(position)))
                        selectGoods.add(dataList.get(position));
                    }
                }
            }
        ...
        buyNum++;
        totalPrice += Double.parseDouble(dataList.get(position).getGoodsprice());
