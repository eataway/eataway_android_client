package com.australia.administrator.australiandelivery.model;
...
import com.australia.administrator.australiandelivery.parse.PreferenceManager;
import com.australia.administrator.australiandelivery.parse.UserProfileManager;
            ...
            public String getDisplayedText(EMMessage message) {
                ...
                if (user != null) {
                    if (EaseAtMessageHelper.get().isAtMeMsg(message)) {
                        return String.format("you in group chat", user.getNick());
                    }
                    return user.getNick() + ": " + ticker;
                } else {
                    if (EaseAtMessageHelper.get().isAtMeMsg(message)) {
                        return String.format("you in group chat", message.getFrom());
                    }
