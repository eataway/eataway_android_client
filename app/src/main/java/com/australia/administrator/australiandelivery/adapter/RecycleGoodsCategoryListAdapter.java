...
public class RecycleGoodsCategoryListAdapter extends RecyclerView.Adapter<RecycleGoodsCategoryListAdapter.ViewHolder> {
    ...
    private List<ShopDetailsBean.MsgBean.ShopmessageBean> dataList;
    public Context mContext;
    public RecycleGoodsCategoryListAdapter(List<ShopDetailsBean.MsgBean.ShopmessageBean> dataList, Context context) {
        this.dataList=dataList;
        this.mContext=context;
    }

    public  void  changeData(List<ShopDetailsBean.MsgBean.ShopmessageBean> dataList){
        this.dataList=dataList;
    ...
    public void onBindViewHolder(RecycleGoodsCategoryListAdapter.ViewHolder holder, final int position) {
        holder.goodsCategoryName.setText(dataList.get(position).getCname());
